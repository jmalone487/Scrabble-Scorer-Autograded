...
// Original Scrabble point structure
...
// Initial prompt to get the word and score it using oldScrabbleScorer
...
function scorerPrompt() {
   ...
   let scorerChoice = "";
   while (scorerChoice === "" || isNaN(scorerChoice) || scorerChoice < 0 || scorerChoice >= scoringAlgorithms.length) {
      scorerChoice = input.question("Enter 0, 1, or 2: ");
      if (isNaN(scorerChoice) || scorerChoice < 0 || scorerChoice >= scoringAlgorithms.length) {
         console.log("Invalid input. Please enter 0, 1, or 2.");
         scorerChoice = "";
      }
   }
   return scoringAlgorithms[scorerChoice];
}
